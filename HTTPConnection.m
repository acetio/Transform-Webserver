...
// Other flags: trace
static const int httpLogLevel = HTTP_LOG_LEVEL_WARN;// | HTTP_LOG_FLAG_TRACE | HTTP_LOG_LEVEL_VERBOSE;
...
/**
 * Parses the post body and returns a dictionary of key value pairs.
 * This method can deal with multi part form data
**/
- (NSDictionary *)parsePostParams {
